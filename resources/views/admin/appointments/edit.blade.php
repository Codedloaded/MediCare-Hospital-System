...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const timeMessage = document.getElementById('appointment-time-message');
    ...
    function generateTimeSlots(startTime, endTime, bookedTimes) {
        ...
        while (currentMinutes < endMinutes) {
            ...
            const isCurrentAppointment = time === currentAppointmentTime;
            ...
            if (time === appointmentTimeInput.value) {
                button.classList.add('selected');
            }
